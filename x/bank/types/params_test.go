...
func Test_ParamEqual(t *testing.T) {
	paramsA := NewParams(true)
	paramsB := NewParams(true)
	paramsC := NewParams(false)
...
func Test_ParamString(t *testing.T) {
	paramString := "default_send_enabled: true\n"
	param := NewParams(true)
